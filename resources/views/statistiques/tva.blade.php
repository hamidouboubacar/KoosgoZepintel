            ...
            <div class="widget-rounded-circle card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="text-end">
                                <h3 class="text-dark mt-1"><span class="toLocalString" data-plugin="">{{ number_format($tva_total,0,'.',' ') }}</span> F CFA</h3>
                                <p class="text-muted mb-1 text-truncate">TOTAL TVA</p>
                            </div>
                        </div>
                    </div> <!-- end row-->
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="text-end">
                                ...
                                <p class="text-muted mb-1 text-truncate">NOMBRE DE FACTURE TVA</p>
                            </div>
                        </div>
                    </div> <!-- end row-->
                </div>
                ...
                <tbody>
                    @if(isset($chiffre_affaires)) @for($i = 0; $i < 12; $i++)
                        <tr>
                            ...
                            <td>{{ number_format($chiffre_affaires_ht['data'][$i],0,'.',' ') }} FCFA</td>
                            <!-- <td>{{ $chiffre_affaires['data'][$i] }} FCFA</td> -->
                            <td>{{ number_format($chiffre_affaires_recouvrement['data'][$i],0,'.',' ') }} FCFA</td>
                            <!-- @if($total_versement == 0)
                                <td> 0 %</td>
                            @else
                                <td>{{ ($chiffre_affaires_recouvrement['data'][$i] / $total_versement) * 100 }} %</td>
                            @endif -->
                            <td>{{ number_format($tva['data'][$i],0,'.',' ') }} FCFA</td>
                        </tr>
                    @endfor @endif
                </tbody>
            </table>
