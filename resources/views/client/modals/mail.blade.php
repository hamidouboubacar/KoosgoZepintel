<div class="modal fade" id="sendMailDocument" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Mail client</h5>
                    ...
                    <div class="form-row">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="email" id="email1" name="email" readonly class="form-control"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
