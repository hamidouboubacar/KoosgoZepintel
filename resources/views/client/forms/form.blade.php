    ...
    <div class="col-3">
        <div class="form-group">
            ...
            <div class="form-check form-check-inline">
                <input class="input-reset form-check-input" type="checkbox" id="recurrence" name="recurrence">
                <label class="form-check-label" for="recurrence">Client  récurrent</label>
            </div>
        </div>
    </div>
    <div class="col-9">
