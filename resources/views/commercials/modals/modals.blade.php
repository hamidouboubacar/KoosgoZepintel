    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('commercials.store') }}" method="post" id="create-form">
                    @csrf
                    @include('commercials.modals.edit')
...
<div class="modal fade" id="editType" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('commercials.update', 0) }}" method="post" id="formUpdate">
                    @csrf
                    @method("PUT")
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('commercials.destroy', 0) }}" method="post" id="formDelete">
                    @csrf
                    @method("DELETE")
