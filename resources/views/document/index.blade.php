                    ...
                    <div class="row mb-2">
                        <div class="col-sm">
                            <div class="d-flex justify-content-end my-2">
                                <a href="{{ route('document.create', ['type' => 'Devis', 'redirect' => url()->current()]) }}" id="btn-create" type="button" class="btn btn-primary waves-effect waves-light"><i class="mdi mdi-plus-circle me-1"></i> Ajouter {{$title}}</a>
                            </div>    
                        </div>
                    </div>
                            ...
                            <tbody>
                                @foreach ($devis as $item)
                                    <tr>
                                        ...
                                        <td class="">
                                            <a href="{{ route('document.edit', ['document' => $item, 'type' => 'Devis', 'redirect' => url()->current()]) }} " title="Modifier" class="action-icon text-primary"> <i class="mdi mdi-square-edit-outline"></i></a>
