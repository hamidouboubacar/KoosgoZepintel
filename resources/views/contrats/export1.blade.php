...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<table id="topdiv">
		<tr>
			<td>
				<div align="left">
					<?php
					//if ($type_entete == "Image") {
					?>
						<img src="<?php   ?>" width="120px" height="120px">
					<?php
					// } else {
					?>
						<img src="<?php   ?>" width="90" height="70">
						<hr />
					<?php
					// }
					?>
	...
	<div id='contentg' style="display:flex; overflow-wrap: break-word; text-align:left; width:100%; flex-wrap: wrap;">
        ...
        <div style="width: 48%;">
			Le service objet du présent contrat consiste en la fourniture d’une connectivité internet,
			<h4><strong><u>ARTICLE 2 : PRIX ET MODALITES DE REGLEMENT</u></strong></h4>
			<p>
				Les montants du présent contrat est de francs CFA par mois. Avec des frais d’installation de francs CFA.
			</p>
			<p>
		...
		<div style="width: 48%;">
				...
				<div style="display: flex; justify-content: space-around;">
					<div>
						...
						<img src="" style="width: 120px; height: 100px; margin:0">
					</div>
					<div>
